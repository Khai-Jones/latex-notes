...
% Define a custom command for highlighting text in a box
...
\declaretheorem[style=thmgreenbox, name=Proof]{pf}
...
\fancyhead[L]{ \small ECON2001 Intermediate Micro II - Project} % Left header
...
% Adjust headheight as per warning message
\setlength{\headheight}{13.2165pt} % Adjust headheight to prevent warnings
