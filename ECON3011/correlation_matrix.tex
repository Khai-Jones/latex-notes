...
point meta max=1,
point meta min=-0.777298125615097,
tick align=outside,
tick pos=left,
x grid style={darkgray176},
xlabel={Key indicator},
xmin=0, xmax=12,
...
xticklabels={
  ...
  Credit extended by Banks to households (Growth Rate),
  Credit extended by Credit Unions to households (Growth Rate),
  Economic Growth (Growth Rate) - Macaronia,
  Fiscal Surplus (Deficit) to GDP,
  Global Economic Growth (Growth Rate),
  Inflation,
...
\addplot graphics [includegraphics cmd=\pgfimage,xmin=0, xmax=12, ymin=12, ymax=0] {correlation_matrix-002.png};
